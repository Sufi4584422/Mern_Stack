    ...
    return (
      <div className="sellerPage">
        ...
        <div className="sellerIntro">
          <h5>Why sell on SellnBuy?</h5>
          <h6>
            We can help you showcase your products to crores of customer &
            businesses - 24 hours a day - on World's most trusted shopping
            destination. More than 5 lakh businnesses, big or small, have
            trusted us with their products.<br></br>
            Start your selleing journey with us & expand your business reach.
          </h6>
        </div>
        ...
        <div className="sellerBenefits">
          ...
          <div className="sellerBenefitsCont">
            <div>
              ...
              <h6>
                Whether you’re banking online or using our Mobile Banking app,
                rest assured you're protected by our Secure Banking Promise.
              </h6>
            </div>
            ...
            <div>
              ...
              <h6>
                Get paid support from SellnBuy's professionals for products
        ...
        <div className="sellerBenefits">
          ...
          <div className="sellerBenefitsCont sellerGrowCont">
            ...
            <div>
              ...
              <h6>
                Reach customers in 250+ cities with our vast network & give your
                products the reach they've always needed!
              </h6>
            </div>
          </div>
        </div>
