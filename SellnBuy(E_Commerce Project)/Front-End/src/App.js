    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Route
          ...
          exact
          render={(props) => (
            <SelectedCategory key={props.location.pathname} {...props} />
          )}
        />
        <Route
        ...
        <Route
          ...
          exact
          render={(props) => (
            <ProductDetails key={props.location.pathname} {...props} />
          )}
        />
        <Route path="/wishlist" exact render={(props) => <Wishlist />} />
        ...
        <Route
          ...
          exact
          render={(props) => (
            <SearchProduct key={props.location.pathname} {...props} />
          )}
        />
        <Route
          path="/search/:searchTerm/:gender"
          exact
          render={(props) => (
            <SearchProduct key={props.location.pathname} {...props} />
          )}
        />
        <Route path="/Seller" exact render={(props) => <Seller />} />
        <Route
          path="/Seller/user"
          exact
